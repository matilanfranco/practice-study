...
export const EXERCISE_CATEGORIES = [
  ...
  { id: "armonia",        label: "Armonía",          emoji: "🎼" },
  { id: "improvisacion",  label: "Improvisación",    emoji: "✨" },
  { id: "repertorio",     label: "Repertorio",       emoji: "🎵" },
  { id: "audioperceptiva",label: "Audioperceptiva",  emoji: "👂" },
